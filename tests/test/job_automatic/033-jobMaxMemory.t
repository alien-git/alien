...

{
  ...
  addFile($cat, "bin/largeMemJob.sh","#!/bin/bash 
...
") or exit(-2);
 ...
 addFile($cat,"jdl/largeMemJob_run.jdl","Executable=\"largeMemJob.sh\";
Memorysize=\{\"1GB\"\};
") or exit(-2);


 addFile($cat,"jdl/largeMemJob_kill.jdl","Executable=\"largeMemJob.sh\";
Memorysize=\{\"0.1GB\"\};
") or exit(-2);
