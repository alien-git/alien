...
sub submitCopiesOnMultipleSes{
  ...
  ($archivename ne "" ) and (scalar(@$filetag) > 0) and $jdlstring .= ",";
...
sub fillTestTableWithTests{
  ...
  $testTable->{a0f3}={archivename=>$archivename3,archivecontent=>\@archivecontent3,ases=>\@ases3,asel=>$asel3,adisk=>$adisk3,atape=>$atape3,aopt=>\@aoptions3,
