...
OutputFile=\"file.out\"", "r") or exit(-2);

  my $procDir=executeJDLFile($cat, "jdl/InputData.jdl") or exit(-2);
  ...
  my ($log)=$cat->execute("get","-f", "$procDir/job-log/execution.out") or exit(-2);
