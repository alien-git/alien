...
$cat->execute("register", "nonExistantFile", "file://nohost/path/to/non/existant/directory",22) or exit(-2);
...
$cat->execute("register", "existantFile", "file://$host/etc/passwd",-s "/etc/passwd") or exit(-2);
