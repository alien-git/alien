...
USER_TESTS_LIST="$USER_BASIC_TESTS_LIST $CATALOGUE_TESTS_LIST $TRANSFERS_TESTS_LIST $JOB_TESTS_LIST 20-xfiles $PACKAGE_TESTS_LIST 68-dbthreads 142-mysqlOpenssl"
...
for FUNCTION in "NEW_MACHINE" "CREATE_CERT" "INSTALL" "CVS_INSTALL" \
    ...
    "PERFORMANCE_TESTS" "BANK_TESTS" "TRANSFERS_TESTS"
do
    if [ "${!FUNCTION}" == "1" ] ;
    then 
