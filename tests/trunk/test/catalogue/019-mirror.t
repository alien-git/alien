...

{
  ...
  open(my $FILE, ">", $fileName) or print "Error opening $fileName\n" and exit(-2);
  print $FILE "Hello world
It is a nice day
";
  close $FILE;
  addFile(
	$cat, "mirror1.txt", "Hello world
It is a nice day
"
  ) or exit(-2);
...
"
  ...
  sleep(5);
  $cat->execute("addMirror", "mirror2.txt", $cat->{CONFIG}->{SE_FULLNAME}, "file://localhost/$fileName", "-c")
	and exit(-2);
