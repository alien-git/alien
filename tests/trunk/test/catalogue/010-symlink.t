...
$cat->execute("add", "-r", "nonExistantFile", "file://$config->{HOST}//path/to/non/existant/directory",22,"abdc") or exit(-2);
...
$cat->execute("add", "-r", "existantFile", "file://$config->{HOST}//etc/passwd", -s "/etc/passwd","abcd") or exit(-2);
