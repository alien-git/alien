...

{
  ...
  $cat->execute("rm", "-silent", "jdl/DONE.jdl");
  ...
  $cat->execute("rm", "-silent", "jdl/DONE_WARN.jdl");
  ...
  $cat->execute("rm", "-silent", "jdl/ERROR_SAVING.jdl");
  addFile($cat, "jdl/ERROR_SAVING.jdl","Executable=\"date\";\n"
