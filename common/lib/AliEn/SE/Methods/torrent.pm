...
sub get {
  ...
  my $args="-V --bt-external-ip=$IP --follow-torrent=mem --timeout=300 --bt-stop-timeout=300 --file-allocation=none --enable-dht=true --bt-request-peer-speed-limit=1M --bt-max-peers=100 --bt-enable-lpd=true";
