...
sub getFieldsFromFileEx {
  ...
  $self->debug(1,
    "In getFieldsFromFileEx fetching attributes $attr with condition $addsql from table $self->{FILETABLE}");
...
sub getFieldFromFileEx {
  ...
  $self->debug(1,
    "In getFieldFromFileEx fetching attributes $attr with condition $addsql from table $self->{FILETABLE}");
...
sub getFieldsFromVolumeEx {
  ...
  $self->debug(1,
    "In getFieldsFromVolumeEx fetching attributes $attr with condition $addsql from table $self->{VOLUMETABLE}");
...
sub getFieldFromVolumeEx {
  ...
  $self->debug(1,
    "In getFieldFromVolumeEx fetching attributes $attr with condition $addsql from table $self->{VOLUMETABLE}");
