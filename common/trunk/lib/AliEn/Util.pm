...
sub JobStatus {
  return ['ASSIGNED','DONE','DONE_WARNING','ERROR_A','ERROR_I','ERROR_E','ERROR_IB','ERROR_M','ERROR_R','ERROR_S','ERROR_SPLT', 'ERROR_SV','ERROR_V','ERROR_VN','EXPIRED','FAILED','FORCEMERGE','IDLE','INSERTING','INTERACTIV','KILLED','MERGING','QUEUED','RUNNING','SAVING','SAVED','SAVED_WARNING', 'SPLIT','SPLITTING','STARTED','WAITING','ZOMBIE', 'ERROR_VT', 'TO_STAGE', 'STAGING', 'A_STAGED'];
}
...
my $ml_status ={'INSERTING' => 1,
		...
		'DONE' => 15,
		'DONE_WARNING' => 16,
		'TO_STAGE'=>17, 'A_STAGED'=>18,'STAGING'=>19, 'SAVED_WARNING'=>20,
